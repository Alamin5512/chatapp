...
verify_token = os.getenv('ALAMIN', None)
# token to send messages through facebook messenger
access_token = os.getenv('EAAFpqWNlVmYBANhpnolxaCFxGgH2O9ySI2aCd3dXE9hwSJ8T7EUZCImxXWJrqGxrrDpqqkgiR2RXEVvOrAUg9hmPToAyPzl6a9FZAqYicmBTRFmV9uVcFtCOnHeXUwb4CeNLQdLXvzaS5e60ObtmV861lm5N36qycSC2xz36HHvXSIRqPG', None)
